...
const ORDERS: OrderConf[] = [
  ...
  { daysAgo:71, hour:13, minute:08, clientIdx:2, shopIdx:0, payMethod:'CASH_ON_DELIVERY', status:'DELIVERED',       itemCount:1, hasTip:true,  tipAmount:500,  hasReview:true,  proRating:4, drvRating:5, proComment:'Bon repas, légèrement tiède à la livraison.',     drvComment:'Super livreur, a attendu patiemment.',          cancelNote:'' },
  ...
  { daysAgo:59, hour:12, minute:03, clientIdx:2, shopIdx:0, payMethod:'CASH_ON_DELIVERY', status:'DELIVERED',       itemCount:3, hasTip:false, tipAmount:0,    hasReview:true,  proRating:3, drvRating:4, proComment:'Correct mais un peu moins épicé qu\'attendu.',     drvComment:'Correct, légèrement en retard.',                cancelNote:'' },
  ...
  { daysAgo:43, hour:18, minute:09, clientIdx:1, shopIdx:0, payMethod:'KKIAPAY',          status:'DELIVERED',       itemCount:2, hasTip:false, tipAmount:0,    hasReview:false, proRating:0, drvRating:0, proComment:'',                                                drvComment:'',                                              cancelNote:'' },
  ...
  { daysAgo:35, hour:19, minute:07, clientIdx:2, shopIdx:0, payMethod:'KKIAPAY',          status:'DELIVERED',       itemCount:2, hasTip:false, tipAmount:0,    hasReview:true,  proRating:5, drvRating:5, proComment:'Sauce graine au top, maman Adjovi fait du bon travail !', drvComment:'Super service de livraison.',              cancelNote:'' },
  ...
  { daysAgo:27, hour:19, minute:04, clientIdx:0, shopIdx:0, payMethod:'KKIAPAY',          status:'DELIVERED',       itemCount:3, hasTip:true,  tipAmount:700,  hasReview:true,  proRating:5, drvRating:5, proComment:'Habitué de la maison, toujours satisfait !',      drvComment:'Excellent service, très ponctuel.',             cancelNote:'' },
  ...
  { daysAgo:18, hour:13, minute:05, clientIdx:2, shopIdx:1, payMethod:'KKIAPAY',          status:'DELIVERED',       itemCount:1, hasTip:true,  tipAmount:500,  hasReview:true,  proRating:5, drvRating:4, proComment:'Burger toujours aussi bon !',                    drvComment:'Bon livreur, discret et efficace.',             cancelNote:'' },
  ...
  { daysAgo: 5, hour:18, minute:03, clientIdx:1, shopIdx:1, payMethod:'CASH_ON_DELIVERY', status:'DELIVERED',       itemCount:1, hasTip:false, tipAmount:0,    hasReview:true,  proRating:5, drvRating:5, proComment:'Classic Burger top qualité !',                   drvComment:'Excellent, livraison parfaite.',                cancelNote:'' },
  ...
  { daysAgo:44, hour:10, minute:07, clientIdx:0, shopIdx:1, payMethod:'KKIAPAY',  status:'CANCELLED',       itemCount:1, hasTip:false, tipAmount:0, hasReview:false, proRating:0, drvRating:0, proComment:'', drvComment:'', cancelNote:'Je rentre cuisiner à la maison finalement.'           },
